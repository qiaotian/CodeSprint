...
string multiply(string num1, string num2)
{
    ...
    for (int i = (int)num1.length()-1, d = (int)rs.length()-1; i >= 0; i--, d--)
    {
        int carry = 0, k = d;
        for (int j = (int)num2.length()-1; j >= 0; j--, k--)
        {
            int a = num1[i] - '0';
            int b = num2[j] - '0';
            a = a*b+carry + (rs[k]-'0');
