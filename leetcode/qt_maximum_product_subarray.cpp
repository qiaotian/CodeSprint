...
* @Last modified time: 2016-07-12T14:23:22+08:00
*/
...
// 2. 数组的结尾
// 3. 数组中为0的某个位置开始
// 也就是说，若一个数组中没有0元，那么最大子数组（1）要么是从0开始，到x结束，x是从0往右累乘得到的最大乘积，我们可以知道，该最大乘积一定是最靠右的累乘为正的元素下表；（2）要么从n-1开始，向左到y结束，其中y是最靠左的满足累乘为正的元素下表
